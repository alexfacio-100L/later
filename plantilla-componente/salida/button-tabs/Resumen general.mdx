...
<SNFigmaImages previewSize="NaturalHeight" variant="plain" columns={1}>
  <SNFigmaFrame id="1e9df347-691a-4610-bb1f-ba2867186963" resourceId="5730af12-cc66-464b-ab10-7f1095998783" src="https://studio-assets.supernova.io/design-systems/825551/938737b4-4cfa-47c2-a48b-f5cd7aa58328.png" title="Las dos variantes" description="`primary` para la acción principal de la vista; `secondary` para las de apoyo." />
</SNFigmaImages>
