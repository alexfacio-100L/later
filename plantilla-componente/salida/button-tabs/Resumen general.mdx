...
<SNFigmaImages previewSize="NaturalHeight" variant="plain" columns={1}>
  <SNFigmaFrame id="1e9df347-691a-4610-bb1f-ba2867186963" resourceId="69041ed5-ea9e-43a8-b64f-22b8e9d52be8" src="https://studio-assets.supernova.io/design-systems/825551/446be30f-b5f8-4545-935e-ee5556064aa8.png" title="Las dos variantes" description="`primary` para la acción principal de la vista; `secondary` para las de apoyo." />
</SNFigmaImages>
