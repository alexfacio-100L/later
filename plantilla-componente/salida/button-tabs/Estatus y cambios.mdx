...
<SNBlock packageId="io.supernova.block.component-checklist">
  <SNItem>
    <SNProp name="components" value={[{ entityId: "d4f71d86-4a9b-4535-949d-0b3aadd0818f", entityType: "Component" }]} />
    <SNProp name="title" value={"Lo que el sistema tiene registrado"} />
...
<SNTable showBorder highlightHeaderRow>
  <SNTableRow>
    <SNTableCell alignment="Left" columnWidth={348}>
      Qué
    </SNTableCell>
    <SNTableCell alignment="Left" columnWidth={319}>
      A quién afecta
    </SNTableCell>
    <SNTableCell alignment="Left" columnWidth={88}>
      Estado
    </SNTableCell>
  </SNTableRow>
  <SNTableRow>
