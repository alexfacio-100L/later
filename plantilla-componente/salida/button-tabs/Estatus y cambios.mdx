**Stable.** El componente está documentado, en uso, y con su escala dimensional ya rehecha: alturas **48 · 56 · 64**, texto **12 · 14 · 16**, iconos **16 · 20 · 24**.
...
<SNTable showBorder highlightHeaderRow>
  ...
  <SNTableRow>
    <SNTableCell alignment="Left" columnWidth={330}>
      Los 60 `labelBox` conservan un `cornerRadius` de 12 que no se ve —no tienen relleno— pero llega a la extracción
    </SNTableCell>
    <SNTableCell alignment="Left" columnWidth={300}>
